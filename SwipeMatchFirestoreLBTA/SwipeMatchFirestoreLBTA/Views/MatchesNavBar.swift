...
class MatchesNavBar: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let iconImageView = UIImageView(image: #imageLiteral(resourceName: "top_right_messages").withRenderingMode(.alwaysTemplate), contentMode: .scaleAspectFit)
               iconImageView.tintColor = #colorLiteral(red: 0.9994985461, green: 0.4413791895, blue: 0.4681275487, alpha: 1)
               let messagesLabel = UILabel(text: "Messages", font: .boldSystemFont(ofSize: 20), textColor: #colorLiteral(red: 0.9994985461, green: 0.4413791895, blue: 0.4681275487, alpha: 1), textAlignment: .center)
